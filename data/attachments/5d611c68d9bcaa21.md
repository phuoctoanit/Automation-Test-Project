...
- Location: /home/runner/work/Automation-Test-Project/Automation-Test-Project/tests/form/00 - validations.spec.ts:204:9
...
- Timeout 3000ms exceeded while waiting on the predicate
    ...
    at /home/runner/work/Automation-Test-Project/Automation-Test-Project/tests/form/00 - validations.spec.ts:235:17
    at /home/runner/work/Automation-Test-Project/Automation-Test-Project/tests/form/00 - validations.spec.ts:234:13
    at /home/runner/work/Automation-Test-Project/Automation-Test-Project/tests/form/00 - validations.spec.ts:211:9
```
...
```ts
   ...
   53 |         expect(parentHasValidated, { message: 'The form should be validated'}).toContain('was-validated');
   54 |
   55 |         const hasInvalid = await locator.evaluate(el => el.matches(':invalid'));
   56 |         expect(hasInvalid, { message: 'The input should be invalid'}).toBe(true);
   57 |
   ...
   72 |         expect(hasInvalid, { message: 'The input should be valid'}).toBe(false);
   73 |
   74 |         const valid = await locator.evaluate(el => el.matches(':valid'));
   75 |         expect(valid, { message: 'The input should be valid'}).toBe(true);
   76 |
